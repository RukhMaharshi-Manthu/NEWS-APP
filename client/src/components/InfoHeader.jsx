    ...
    return (
        <Box className={classes.container}>
            ...
            <Box style={{marginLeft: 'auto'}}>
             <a href="https://apps.apple.com/in/app/dailyhunt-formerly-newshunt/id338525188" target="_blank">
                <img src={appleStore} alt="apple store"  className={classes.logo} />
                </a>
                <a href="https://play.google.com/store/apps/details?id=com.eterno" target="_blank">
